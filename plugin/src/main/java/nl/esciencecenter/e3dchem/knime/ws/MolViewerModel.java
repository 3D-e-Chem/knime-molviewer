...
public class MolViewerModel extends NodeModel {
    ...
    private static final NodeLogger logger = NodeLogger
            .getLogger(MolViewerModel.class);
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
    	...
    	BufferedDataTable ligandDataTable = inData[LIGAND_PORT];
    	 int ligandColIndex = ligandDataTable.getDataTableSpec().findColumnIndex(
    			 m_ligand_column.getStringValue());
    	 
    	 ligands = new ArrayList<String>();
    	 for (DataRow currRow : ligandDataTable) {
    		 DataCell currCell = currRow.getCell(ligandColIndex);
    		 String currValue = ((SdfValue) currCell).getSdfValue();
    		 ligands.add(currValue);
    	 }
