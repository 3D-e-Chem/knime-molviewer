 ...
 *
 */
public class MolViewerFactory
        extends NodeFactory<MolViewerModel> {
     ...
     */
    @Override
    public NodeView<MolViewerModel> createNodeView(final int viewIndex,
            final MolViewerModel nodeModel) {
